    ...
    <div class="row content">
        ...
        <div class="col-md-7 col-sm-12">
            ...
            <form action="" method="POST">
             ...
             <div class="col-md-7 col-sm-12"><input type="submit" class="btn btn-outline-primary my-2 my-sm-0 login" type="submit" value="Iniciar Sesión    "></button></div>
        ...
        <div class="col-lg-5 col-sm-12">
            <div class=row>
                ...
                <div class=row>
                    ...
                    <input type="image" name="submit" src="images/logingoogle.png" border="0" alt="Submit" style="width: 200px;" />
                    </div>
                </div>
                </div>
