...
<div class="container text-justify">
    <div class="row content">
        ...
        <ol>
            ...
            <li>El Usuario se compromete a no hacerse pasar por otra persona u organización, lo que puede constituir un delito de suplantación de identidad de acuerdo con el Código Penal Español.</li>
            <li>El Usuario se compromete a no acosar a cualquier otro usuario y utilizar un lenguaje respetuoso y no ofensivo con el resto de Usuarios.</li>
            <li>El Usuario se compromete a no eludir, desactivar o interferir en las funciones relacionadas con la seguridad del Sitio Web que impidan o limiten el uso o copia de cualquier Contenido o hacer cumplir las limitaciones del uso del Sitio web o su Contenido en el mismo.</li>
            <li>No se permite el uso de la firma o avatar como medio de promoción o publicidad de productos, servicios, programas de afiliados o webs, en el caso de que contengan publicidad o tengan fines comerciales.</li>
            <li>No se permite el uso de múltiples cuentas por un mismo usuario salvo casos excepcionales autorizados por un administrador o motivos justificados (múltiples usuarios en un mismo ordenador, etc). La detección de este hecho puede dar lugar al bloqueo de todas las cuentas asociadas al mismo usuario y/o bloqueo permanente de acceso.</li>
            <li>El uso de esta web como medio para organizar ataques o spam a cualquier tipo de servicio (foros, webs, etc) no está permitido. Ese tipo de contenidos podrán ser eliminados y las cuentas que incumplan esta norma podrán ser igualmente canceladas.</li>
            <li>El administrador y moderadores del sitio web tienen el derecho a borrar, editar, mover o cerrar cualquier contenido y/o cuenta de usuario que incumpla cualquier de las normas y obligaciones descritas en estos términos legales o pueda ser considerado inapropiado por la EMPRESA.</li>
            <li>No son admisibles mensajes con amenazas, insultos graves o cualquier otro tipo de comentario que pueda herir la sensibilidad del destinatario. En tal caso, nos reservamos el derecho de avisar a las autoridades pertinentes.</li>
        ...
        <ol>
            ...
            <li>Los contenidos de este sitio web, incluyendo diseños, aplicaciones, texto, imágenes, cómics y código fuente (“Contenido”), están protegidos por derechos de propiedad intelectual.</li>
            <li>Los contenidos no se podrán utilizar, reproducir, copiar o transmitir en forma alguna por un tercero sin el permiso previo, escrito y explícito de la EMPRESA. En especial, dichos contenidos no se podrán utilizar, integrar, capturar o reproducir, salvo en caso de que se integren en la interfaz de una aplicación, página web o sistema que mantenga, muestre, publique o explote otros contenidos relevantes o principales, siendo en este caso la importancia de los contenidos publicados por la EMPRESA accesoria, anecdótica o irrelevante frente a aquéllos. Esta excepción no tendrá efecto cuando el tercero titular de la aplicación, página web o sistema desarrolle una actividad económica o empresarial u obtenga cualquier tipo de lucro, directo o indirecto, asociado a la misma, en cuyo caso la autorización deberá ser necesariamente recabada de la empresa con carácter previo, escrito y expreso.</li>
            <li>La titularidad de los contenidos, respuestas y comentarios introducidos por los usuarios pertenece a sus correspondientes autores. La EMPRESA no se responsabiliza de las opiniones emitidas por los autores de dichos contenidos.</li>
        ...
        <ol>
            ...
            <li>El Sitio Web puede contener enlaces a sitios web de terceros que no son propiedad o no son controladas por la EMPRESA, quien carece de control sobre, y no asume ninguna responsabilidad por el contenido, políticas de privacidad o prácticas de los sitios web de terceros. Además, la EMPRESA  no puede censurar o editar el contenido de cualquier sitio de terceros. Mediante el uso del Sitio Web  expresamente excluye a la EMPRESA de toda y cualquier responsabilidad que surja del uso de cualquier sitio web de terceros.</li>
